...
if __name__ == '__main__':
    ...
    for itr in range(0, num_iter):
        ...
        err_consistency_scaled = 300*err_consistency/scale_error
        ...
        loss = alpha*loss_fit + (1.0-alpha)*loss_consistency #+ loss_hidden_norm
        ...
        if itr % test_freq == 0:
            print(f'Iter {itr} | Tradeoff Loss {loss:.6f}   Consistency Loss {loss_consistency:.6f}   Fit Loss {loss_fit:.6f} Loss Size Norm {loss_hidden_norm:.6f}')
